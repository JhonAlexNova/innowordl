...
<div class="acciones d-flex flex-wrap mb-4 align-items-center">
	<a href="{{url('app/usuarios')}}?page=nuevos_clientes&type=list" class="mr-3 mb-2 icono list active" style="padding: 4px 10px 10px 10px;">
		<i class="fa fa-list"></i>
	</a>
	<a href="{{url('app/usuarios')}}?page=nuevos_clientes&type=card" class="mb-2 icono card" style="padding: 10px 10px 10px 10px;">
		                        		...
		                        		<tr>
											...
											<td>
												<?php 
												 ...
												 ?>
												 <a href="{{url('app/usuarios',$id)}}/edit?page=nuevos_clientes" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
											</td>	
						...
						<div class="card-body">	
							...
							<div class="d-flex align-items-center mt-4">
								<?php 
									$id = base64_encode($value->id_user);
								 ?>
								<a href="{{url('app/usuarios',$id)}}/edit?page=nuevos_clientes" class="btn btn-outline-primary light  mr-auto" style="padding: 5px">EDITAR</a>
