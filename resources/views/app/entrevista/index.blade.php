<div class="row">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Entrevistas</a></li>
        </ol>
    </div>
</div>
			...
			<div class="col-12">
		        <div class="card">
		            <div class="card-header">
		                <h4 class="card-title">Clientes para entrevista</h4>
		            </div>
		            <div class="card-body">
		                        		...
		                        		<tr>
											...
											<td>
												<?php 
												 ...
												 ?>
												 <a href="{{url('app/usuarios',$id)}}/edit?page=entrevistas&id_det_asig={{ $id_det_asig }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
											</td>
