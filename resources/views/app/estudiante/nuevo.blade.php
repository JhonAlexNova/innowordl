<div class="row">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Estudiantes nuevos</a></li>
        </ol>
    </div>
</div>

<div class="acciones d-flex flex-wrap mb-4 align-items-center">
	<a href="{{url('app/usuarios')}}?page=estudiantes_nuevos&type=list" class="mr-3 mb-2 icono list active" style="padding: 4px 10px 10px 10px;">
		<i class="fa fa-list"></i>
	</a>
	<a href="{{url('app/usuarios')}}?page=estudiantes_nuevos&type=card" class="mb-2 icono card" style="padding: 10px 10px 10px 10px;">
		                        		...
		                        		<tr>
											...
											<td>
												<?php 
												 ...
												 ?>
												 <a href="{{url('app/usuarios',$id)}}/edit?page=estudiantes_nuevos&id_det_asig={{ $id_det_asig }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
											</td>
						...
						<div class="card-body">	
							...
							<div class="d-flex align-items-center mt-4">
								<?php 
									...
									$id_det_asig = base64_encode($value->id_det_asig);
								 ?>
								<a href="{{url('app/usuarios',$id)}}/edit?page=estudiantes_nuevos&id_det_asig={{ $id_det_asig }}" class="btn btn-primary light btn-rounded mr-auto">EDITAR</a>
