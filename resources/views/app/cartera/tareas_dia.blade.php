...
<div class="row">
	    <div class="page-titles">
	        <ol class="breadcrumb">
	            ...
	            <li class="breadcrumb-item active"><a href="javascript:void(0)">Tareas</a></li>
	        </ol>
	    </div>
	</div>
				...
				<div class="col-12">
			        <div class="card">
			            <div class="card-header">
			                <h4 class="card-title">  <small class="text-danger"> <i class="fa fa-exclamation-triangle"></i>  Tareas del dia</small></h4>
			            </div>
			            <div class="card-body">
			                <div class="table-responsive">
			                    ...
			                    <table id="example" class="display min-w850 dataTable" role="grid" aria-describedby="example_info">
			                        ...
			                        <tbody> 
			                        	@foreach($tareas_dia as $key => $value)
			                        		<tr>
			                        			<td> {{ $key }} </td>
				                        		...
				                        		<td>
													<?php 
													 ...
													 ?>
													 <a href="{{url('app/cartera',$id)}}?page=tareas_dia" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
												</td>
			                        		</tr>
