	...
	<div class="row">
	    <div class="page-titles">
	        <ol class="breadcrumb">
	            ...
	            <li class="breadcrumb-item active"><a href="javascript:void(0)">Pendientes por pago</a></li>
	        </ol>
	    </div>
	</div>

	<div class="acciones d-flex flex-wrap mb-4 align-items-center">
		<a href="{{url('app/usuarios')}}?page=facturacion_pendiente_pago&type=list" class="mr-3 mb-2 icono list active" style="padding: 4px 10px 10px 10px;">
			<i class="fa fa-list"></i>
		</a>
		<a href="{{url('app/usuarios')}}?page=facturacion_pendiente_pago&type=card" class="mb-2 icono card" style="padding: 10px 10px 10px 10px;">
				...
				<div class="col-12">
			        <div class="card">
			            <div class="card-header">
			                <h4 class="card-title">Listado pendientes por pago</h4>
			            </div>
			            <div class="card-body">
			                        ...
			                        <tbody> 
			                        	@foreach($users as $key => $value)
			                        		<tr>
			                        			...
			                        			<td> {{$value->email}} </td>
			                        			<td>
	 			                        				@if($value->fecha_acuerdo < $fecha )<!-- la actividad esta vencida-->
				                        					<span class="badge light badge-danger">
																<i class="fa fa-circle text-danger mr-1"></i>
																{{$value->fecha_acuerdo}}
															</span>
														@elseif($value->fecha_acuerdo == $fecha)
