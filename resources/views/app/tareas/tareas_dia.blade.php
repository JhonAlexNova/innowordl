<div class="row">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Tareas del dia</a></li>
        </ol>
    </div>
</div>

<div class="acciones d-flex flex-wrap mb-4 align-items-center">
	<a href="{{url('app/usuarios')}}?page=tareas_dia&type=list" class="mr-3 mb-2 icono list active" style="padding: 4px 10px 10px 10px;">
		<i class="fa fa-list"></i>
	</a>
	<a href="{{url('app/usuarios')}}?page=tareas_dia&type=card" class="mb-2 icono card" style="padding: 10px 10px 10px 10px;">
			...
			<div class="col-12">
		        <div class="card">
		            <div class="card-header">
		                <h4 class="card-title">Listado de tareas del dia</h4>
		            </div>
		            <div class="card-body">
		                        		...
		                        		<tr>
											...
											<td>
												<?php 
												 ...
												 ?>
												 <a href="{{url('app/usuarios',$id)}}/edit?page=tareas_dia" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
											</td>	
						...
						<div class="card-body">	
							...
							<div class="d-flex align-items-center mt-4">
								<?php 
									$id = base64_encode($value->id_user);
								 ?>
								<a href="{{url('app/usuarios',$id)}}/edit?page=tareas_dia" class="btn btn-primary light btn-rounded mr-auto">EDITAR</a>
