<div class="row">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Tareas del vencidas</a></li>
        </ol>
    </div>
</div>

<div class="acciones d-flex flex-wrap mb-4 align-items-center">
	<a href="{{url('app/usuarios')}}?page=tareas_vencidas&type=list" class="mr-3 mb-2 icono list active" style="padding: 4px 10px 10px 10px;">
		<i class="fa fa-list"></i>
	</a>
	<a href="{{url('app/usuarios')}}?page=tareas_vencidas&type=card" class="mb-2 icono card" style="padding: 10px 10px 10px 10px;">
						...
						<div class="card-body">	
							...
							<div class="d-flex align-items-center mt-4">
								<?php 
									$id = base64_encode($value->id_user);
								 ?>
								<a href="{{url('app/usuarios',$id)}}/edit?page=tareas_vencidas" class="btn btn-primary light btn-rounded mr-auto">EDITAR</a>
